...
const CategoryCard = ({ title, description, disclaimer }: CategoryProps) => (
  <div className="minimal-card hover:bg-accent-success transition-colors duration-200 cursor-pointer">
...
const DuplicateCategoriesSection = () => {
  const categories = [
    {
    ...
    <section className="section-spacing bg-accent-success theme-transition">
      <div className="content-container">
        <div className="content-narrow">
          ...
          <p className="text-xl mb-12 font-semibold">
...
export default DuplicateCategoriesSection;
