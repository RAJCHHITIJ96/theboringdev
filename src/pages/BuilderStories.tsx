...
const BuilderStories = () => {
  const articles = [
    {
      title: "From Side Project to $10K MRR",
      date: "June 2025",
      readTime: "5 min read",
      excerpt: "What's actually working for developers vs. what gurus claim works. Real wins from real builders..."
    },
    {
      title: "Building in Public: The Real Numbers",
      date: "May 2025",
      readTime: "4 min read",
      excerpt: "A developer's honest journey building an AI tool, including revenue, costs, and lessons learned..."
    },
    {
      title: "Solo Developer Success Patterns",
      date: "May 2025",
      readTime: "6 min read",
      excerpt: "Analyzing what actually works for indie developers in the AI space, backed by real data..."
    }
  ];
