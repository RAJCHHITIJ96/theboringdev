  ...
  const articles = [
    {
      ...
      description: "What's actually working for developers vs. what gurus claim works. Real implementation details.",
      category: "BUILDERS"
    },
    {
      ...
      date: "May 2025", 
      readTime: "9 min read",
      description: "Real implementation stories from successful AI builders. The unglamorous truth about building profitable AI products.",
      category: "BUILDERS"
    },
    {
      ...
      description: "Real wins from real builders, including the failures nobody talks about. Technical decisions that actually work.",
      category: "BUILDERS"
    }
  ];
