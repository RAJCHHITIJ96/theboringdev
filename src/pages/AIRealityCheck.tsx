  ...
  const articles = [
    {
      ...
      date: "June 2025",
      readTime: "8 min read",
      description: "Separating genuine breakthroughs from marketing campaigns. Truth over trending topics, with data-backed analysis of what's real and what's manufactured buzz.",
    ...
    },
    {
      ...
      date: "May 2025", 
      readTime: "6 min read",
      description: "Not echo chamber amplification, but honest analysis of where AI actually delivers value. Market realities beyond the venture capital narratives.",
      category: "REALITY CHECK"
    },
    {
      ...
      date: "May 2025",
      readTime: "7 min read",
      description: "Hard truths about the AI market that nobody wants to discuss. Failure patterns, market saturation, and the few areas where opportunities still exist.",
      category: "REALITY CHECK"
    }
  ];
