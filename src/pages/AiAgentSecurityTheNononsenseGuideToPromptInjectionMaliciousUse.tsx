      ...
      <main className="max-w-[680px] mx-auto px-10 pb-32">
        <article className="space-y-8">
          ...
          <p style={{
            ...
            Hero Image: https://i.ibb.co/CDntGwT/Stylized-graphic-for-theboringdev-showing-Kill-Prompt-Injection-Live-Unhacked-against-a-tech-backgro.png The AI Security Reality: Kill Prompt Injection. Live Unhacked. Stop the Hype. Start Building Bulletproof AI Agents. This is the only guide you&#039;ll ever need.}
          </p>
