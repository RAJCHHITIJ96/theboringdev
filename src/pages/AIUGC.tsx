      ...
      <div className="bg-white">
        ...
        <header className="max-w-[680px] mx-auto pt-32 pb-16 text-center px-10">
          <div className="mb-12">
            ...
            <div className="w-16 h-px mx-auto bg-gray-300 mb-8"></div>
              ...
              <div className="rounded-2xl p-8 mb-12 border-l-4 border-black bg-gray-50" style={{ margin: '48px 0' }}>
                ...
                <ul className="space-y-6 text-base text-gray-600">
                  <li className="flex items-start" style={{ marginBottom: '16px', paddingLeft: '0' }}>
                    <span className="inline-block w-8 h-8 bg-black text-white text-sm rounded-full flex items-center justify-center mr-4 mt-1" style={{ fontFamily: "'Inter', sans-serif" }}>1</span>
                    <span style={{
                      fontFamily: "'Inter', -apple-system, sans-serif",
                      fontSize: '19px',
                      lineHeight: '1.7',
