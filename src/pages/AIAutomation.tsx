...
const AIAutomation = () => {
  const articles = [
    ...
    },
    {
      ...
      date: "May 2025", 
      readTime: "6 min read",
      description: "How to implement AI systems that pay for themselves within 90 days. Case studies from businesses.",
      category: "AUTOMATION"
    },
    {
      ...
      date: "May 2025",
      readTime: "8 min read",
      description: "From workflow analysis to deployment, everything you need to automate business processes with AI.",
      category: "AUTOMATION"
    }
  ];
